...
/* 内存池(64字节对齐) */
//static __align(64) uint8_t mem1base[MEM1_MAX_SIZE] __attribute__((at(0x24048000)));                                                           /* 内部SRAM内存池 */
...
static __align(64) uint8_t mem5base[MEM5_MAX_SIZE] __attribute__((at(0x20010000)));                           /* 内部DTCM内存池 */
...
static MT_TYPE mem5mapbase[MEM5_ALLOC_TABLE_SIZE] __attribute__((at(0x20010000 + MEM5_MAX_SIZE)));            /* 内部DTCM内存池MAP */
