...
#define SRAM12                  1                               /* SRAM1/2/3内存池,SRAM1+SRAM2,共256KB */
...
//#define MEM1_MAX_SIZE           32 * 1024                      /* 最大管理内存 448K,H7的AXI内存总共512KB */
...
#define MEM3_MAX_SIZE           30 * 1024                      /* 最大管理内存240K,H7的SRAM1+SRAM2共256KB */
#define MEM3_ALLOC_TABLE_SIZE   MEM3_MAX_SIZE / MEM3_BLOCK_SIZE /* 内存表大小 */

/* mem4内存参数设定.mem4是H7内部的SRAM4内存 */
#define MEM4_BLOCK_SIZE         64                              /* 内存块大小为64字节 */
#define MEM4_MAX_SIZE           14 * 1024                       /* 最大管理内存60K,H7的SRAM4共64KB */
...
#define MEM5_MAX_SIZE           56 * 1024                      /* 最大管理内存120K,H7的DTCM共128KB */
